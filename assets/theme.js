...
(function toggle_header_menu() {
	...
	var set_dropdown_maxH = function() {
		...
		if ($ttDesctopMenu_H > menu_max_H) {
			...
			$('.tt-header-static').length && $('.tt-header-static').css({
...
var tooltip = {
	...
	showTooltip: function($o, h, v, p) {
		...
		$o.css({
			'top': v,
			'left': h
		}).addClass('tooltip-' + p).animate(a, 200);
	}
}
$(document).ready(function() {
	tooltip.init();
...
var ct = {
	...
	replaceSliderArrows: function(h) {
		...
		prev.addClass('showarr').css({
			top: c
		});
		next.addClass('showarr').css({
			top: c
		});
	},
	sliderinit: function() {
